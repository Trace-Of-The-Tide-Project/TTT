...
export function ShareYourStory() {
  return (
    <section className="flex flex-col items-center px-6 py-20 text-center">
      <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-full border border-[#333333]">
      ...
      <h2 className="mb-4 text-2xl font-semibold text-white">Share your story</h2>
