/**
 * The site's signature rounded hexagon, as a CSS `clip-path` value.
 *
 * Extracted from HexImageGrid so other surfaces (writer avatars, …) mask to the
 * exact same geometry instead of each re-deriving a polygon that drifts.
 */
export const TOTT_HEX_CLIP_PATH =
