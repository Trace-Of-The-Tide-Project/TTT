...
export function RelatedContentCard({
  ...
  const card = (
    <SpringCard
      ...
      className="group relative m-0 flex shrink-0 cursor-pointer p-0"
      style={{ width: HEX_W }}
    >
      <div
      ...
      >
        {/* Image with shared-layout layoutId for morph to detail hero */}
        <SharedImage
          layoutId={id ? `content-hero-${id}` : undefined}
