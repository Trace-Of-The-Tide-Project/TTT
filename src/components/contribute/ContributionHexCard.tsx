...
/** Inner fill when selected/hovered (theme-aware elevated surface). */
const HEX_INNER_SELECTED = "var(--tott-elevated)";
...
export function ContributionHexCard({
  ...
  return (
    <button
      ...
      className={`group relative -mx-[12px] -my-[18px] flex w-[190px] shrink-0 cursor-pointer flex-col items-center justify-center gap-1 px-3 py-4 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[var(--tott-accent-gold)] focus:ring-offset-0 focus:ring-offset-transparent ${className}`}
      style={{
