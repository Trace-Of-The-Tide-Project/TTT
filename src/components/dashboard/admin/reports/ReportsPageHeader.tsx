    ...
    <div className="px-6 py-6 sm:px-8 sm:py-8">
      ...
      <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="relative flex flex-col items-center gap-2 px-4 py-7"><ChamferedFrame />
          ...
          <span className="text-xs text-[var(--tott-muted)]">{t("cards.pendingReports")}</span>
        </div>
        ...
        <div className="relative flex flex-col items-center gap-2 px-4 py-7"><ChamferedFrame />
          ...
          <span className="text-xs text-[var(--tott-muted)]">{t("cards.contentFlagged")}</span>
        </div>
        ...
        <div className="relative flex flex-col items-center gap-2 px-4 py-7"><ChamferedFrame />
          ...
          <span className="text-xs text-[var(--tott-muted)]">{t("cards.usersReported")}</span>
        </div>
        ...
        <div className="relative flex flex-col items-center gap-2 px-4 py-7"><ChamferedFrame />
          ...
          <span className="text-xs text-[var(--tott-muted)]">{t("cards.resolvedToday")}</span>
        </div>
      </div>
    </div>
  );
