// PRESERVED — the full editorial homepage. Temporarily replaced by a
// Coming Soon page (see ./page.tsx) while the team decides what to feature.
// To restore: copy this component back into ./page.tsx as the default export.
// Nothing here is deleted; this file is intentionally not a route (only
// `page.tsx` is), so none of this code runs until it's restored.
