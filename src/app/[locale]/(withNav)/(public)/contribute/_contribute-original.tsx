...
// by the Next.js App Router). This is the full working "Leave a Trace"
// contribution page that `contribute/page.tsx` rendered before the
// "Coming Soon" override. To restore /contribute, either copy this body
// back into `page.tsx` (restore the `ContributePage` default export) or
// change `page.tsx` to:
//   export { ContributePageOriginal as default } from "./_contribute-original";
"use client";
...
export default function ContributePageOriginal() {
